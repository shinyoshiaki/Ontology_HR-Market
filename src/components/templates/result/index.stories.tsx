...
import { listResultBitStory } from "../../molecules/listResultAuction/index.stories";
...
export const resultStory: IResultTempProps = {
  ...Object.assign({}, headerOrgStory, listResultBitStory, detailWorkerStory, FormResultApproveStory)
};
